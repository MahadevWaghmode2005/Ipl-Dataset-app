...
st.markdown(
    "Predict whether **team1** wins or not using logistic regression on past IPL data.")
...
if uploaded_file is not None:
    ...
    df.drop(columns=['id', 'date', 'winner', 'umpire3'],
    ...
    coef_df = coef_df.reindex(
        coef_df.Importance.abs().sort_values(ascending=False).index)
